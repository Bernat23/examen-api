...
const getAllProductes = (req, res) => {
    try {
      const allProducte = producteService.getAllProductes();
      res.send({ status: "OK", data: allProducte });
    } catch (error) {
      res
...
const getOneProducte = (req, res) => {
  ...
  const createNewProducte = (req, res) => {
    ...
    try {
      const createdProducte = producteService.createNewProducte(nouProducte);
